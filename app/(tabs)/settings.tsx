      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <SettingSection title="Account">
          ...
          <Pressable style={styles.settingRow} onPress={() => {
            ...
            } else if (auth.isGuest) { auth.upgradeFromGuest(); }
          }}>
            <View style={styles.settingInfo}>
              <Text style={styles.settingLabel}>{auth.user ? "Signed in as " + auth.user.email : "Guest Mode"}</Text>
              <Text style={styles.settingDesc}>{auth.user ? "Tap to sign out" : "Sign in to sync your data"}</Text>
            </View>
