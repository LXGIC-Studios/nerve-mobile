        ...
        <View style={s.form}>
          ...
          <View style={s.field}>
            ...
            <TextInput style={s.input} value={email} onChangeText={setEmail} placeholder="you@example.com"
              placeholderTextColor={colors.textTertiary} keyboardType="email-address" autoCapitalize="none" autoCorrect={false} autoComplete="email" editable={!loading} />
          </View>
          <View style={s.field}>
          ...
          <Pressable style={s.ghostBtn} onPress={() => { Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light); continueAsGuest(); }}>
